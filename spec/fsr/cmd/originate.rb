...
describe "Testing FSR::Cmd::Originate" do
  ...
  it "Originates calls to extensions" do
    ...
    originate.raw.should == "originate {ignore_early_media=true,originate_timeout=15,origination_caller_id_name=FSR,origination_caller_id_number=8675309}user/bougyman 4000"
  end
